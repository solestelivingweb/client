...
import artandcoulturecenter from "../../../images/undef/artandcoulturecenter.jpeg";
import westlakepark from "../../../images/undef/westlakepark.jpeg";

const AreTmp = (i, n, d) => {
  return (
    <div>
      <AttractionsImage nbaIMAGE={i} nbaNAME={n} nbaDESCRIPTION={d} />
    </div>
  );
};
...
const Are65 = () => {
  return AreTmp(
    ...
    "The Ancient Spanish Monastery is located at 16711 West Dixie Highway, North Miami Beach, FL 33160. It is open from 10:00 a.m. to 4:00 p.m., Monday through Friday. Operating hours vary on the weekends. The latest any visitor is allowed to come on property, unless they have special permission, is 4:00 p.m."
  );
};
...
const Are86 = () => {
  return AreTmp(
    westlakepark,
    "West Lake Park",
    "This lakeside park has a marina with canoe/kayak rentals, a playground, ball courts & picnic areas."
  );
};

const Are87 = () => {
  return AreTmp(
    artandcoulturecenter,
    "Art and Culture Center",
    "The Art and Culture Center/Hollywood is an arts venue in Hollywood, Florida at 1650 Harrison Street in Broward County. The Center presents contemporary visual and performing arts shows and includes an adjacent art school and the Hollywood Central Performing Arts Center at 1770 Monroe Street."
  );
};
  ...
  render() {
    return (
      <div className="Section3NBACarousel-image">
        ...
        <p className="text-center mt-4 pr-3 pl-3">{this.props.nbaDESCRIPTION}</p>
      </div>
    );
  }
}
