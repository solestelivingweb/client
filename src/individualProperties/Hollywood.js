...
// 2022
import hollywoodmiddletopimg from "../images/individualProperties/hollywood-2022/Feb-2022-Hollywood/Soleste Hollywood Rendering 5.jpg";
  ...
  render() {
    return (
      <div>
        <Helmet>
          <meta charSet="utf-8" />
          <title>Soleste Living | Hollywood Boulevard</title>
          <meta name="description" content="Soleste Hollywood Boulevard" />
          <meta name="keywords" content="Soleste Hollywood Boulevard" />
        </Helmet>
        <MobileView>
          <EachPageHeader
        ...
        <PropertyDescriptionLeft
          propertyComponentImage={
            "https://images.unsplash.com/photo-1619503463038-4c0e04ddb9ab?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1287&q=80"
          }
        ...
        <PropertyDescriptionRight
          propertyComponentImage={
            "https://images.unsplash.com/photo-1497215641119-bbe6d71ebaae?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80"
          }
